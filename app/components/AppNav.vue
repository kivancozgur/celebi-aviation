<template>
  <header>
    ...
    >
      <div
        class="mx-auto mt-2 max-w-5xl rounded-2xl border border-white/10 backdrop-blur-xl bg-gray-950/50 px-3"
      >
        <div
          class="relative flex flex-wrap items-center justify-between gap-3 py-3 px-3 md:px-5"
        >
          ...
          <div class="flex w-full justify-between lg:w-auto">
            ...
            <div class="flex gap-2 lg:hidden">
              ...
              >
                <span
                  class="flex flex-col justify-center items-center w-5 h-5 relative"
                >
                  <span
          ...
          <div
            class="absolute inset-0 m-auto hidden lg:flex items-center justify-center w-fit h-fit top-1/2 -translate-y-1/2"
          >
            <ul class="flex items-center gap-1">
              <li v-for="link in links" :key="link.key" class="relative group">
                ...
                >
                  <div
                    class="bg-white rounded-xl shadow-[0_8px_30px_rgba(0,0,0,0.08)] border border-gray-100 py-2 min-w-[220px]"
                  >
                    <NuxtLink
                    ...
                    >
                      <span
                        class="w-1 h-1 rounded-full bg-gray-300 flex-none"
                      />
                      {{ $t(child.key) }}
                    </NuxtLink>
                  </div>
          ...
          <div class="hidden lg:flex items-center gap-2">
            <!-- Language Switcher -->
            <div
              class="flex items-center gap-1 text-[11px] font-medium tracking-[1.5px] text-white/40"
            >
              <button
                @click="setLocale('tr')"
          ...
          >
            <div class="space-y-6">
              ...
              <div v-for="category in mobileCategories" :key="category.label">
                <p
                  class="text-[11px] font-semibold tracking-[2px] uppercase text-gray-400 mb-3"
                >
                  {{ category.label }}
                </p>
                <ul class="space-y-1">
            ...
            >
              ...
              <div
                class="text-xs font-medium tracking-[1px] text-gray-400 flex items-center gap-1"
              >
                <button
                  @click="setLocale('tr')"
                  :class="locale === 'tr' ? 'text-gray-900' : 'opacity-40'"
                ...
                <button
                  @click="setLocale('en')"
                  :class="locale === 'en' ? 'text-gray-900' : 'opacity-40'"
                  class="transition-opacity cursor-pointer"
                >
                  EN
                </button>
